...
class LLMClient:
    ...
    async def chat_complete_json(self, prompt: str, system_instruction: str = "") -> dict[str, Any]:
        ...
        if "synonym" in prompt_lower or "alternative academic phrasing" in prompt_lower:
            ...
            # We are generating why_match
            # Return a generic why_match that refers to candidate and student areas
            return {
                "why_match": "The researcher's active publications align strongly with the student's stated interests and academic goals, suggesting a high-quality match for research collaboration.",
                "fit_confidence": 0.85
            }
